...
public class SimpleFragment extends Fragment {
	...
	// A ViewGroup is an abstract class that all ViewGroups like LinearLayout extends
	// A Bundle is used to pass data between Activities such as
	// variable data you'd want saved if the orientation of the device changes
	@Override
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
			Bundle savedInstanceState) {
		// Inflate the Fragment, but don't attach it to the main activity LinearLayout because attachToRoot is marked as false
